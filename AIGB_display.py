...
def view_display(temp=0, hum=0, co2=0, ph=0, ec=0):
    ph = int(ph)
    ec = int(ec)
    draw = display.draw
    ...
    draw.text((0, 135), "pH-value", fill = (128,255,128),font=font2)
    draw.text((0, 165), "Conductivity", fill = (128,255,128),font=font2)
#     draw.text((0, 195), "pH", fill = (128,255,128),font=font2)
    ...
    draw.text((140, 135), ph, fill = (128,255,128),font=font2)
    display.update_partial(140, 135, 220, 157)
    
    draw.text((140, 165), ec[0:4]+"V", fill = (128,255,128),font=font2)
